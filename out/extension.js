...
function activate(context) {
    ...
    vscode.window.registerWebviewViewProvider('catppuccinPaletteSidebar', new CatppuccinSidebarProvider(context)), vscode.commands.registerCommand('catppuccinPalette.openCatppuccinPalette', () => {
        ...
        if (panel) {
            ...
            panel = vscode.window.createWebviewPanel('catppuccinPalette', // Identifies the type of the webview. Used internally
...
class CatppuccinSidebarProvider {
    context;
    constructor(context) {
